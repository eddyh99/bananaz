...
//      );
  ...
  Future<bool> checkOrder(
      ...
      returnTime}) async {
    http.Response data = await http.get(
        "https://www.bananaz.co/ios/cekreservasi/?pick_up_date=$pickupDate&return_date=$returnDate&pick_up_location=$pickupLocation&return_location=$returnLocation&pick_up_time=$pickupTime&return_time=$returnTime");
                ...
                if (snapshot.data == null) {
                  ...
                  return new ListView.builder(
                    ...
                    controller: PageController(
                        keepPage: true, initialPage: 0, viewportFraction: .42),
                    itemCount: snapshot.data.length,
                    itemBuilder: (context, i) {
                      return new Container(
                        width: 150,
...
//                    return new Container(
//                        alignment: FractionalOffset(20,0),
//                        padding: EdgeInsets.symmetric(horizontal: 5),
//                        child: new GestureDetector(
//                          onTap: () {
//                            Navigator.of(context).push(new MaterialPageRoute(
