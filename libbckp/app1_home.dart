...
class AppPage1Provider {
  ...
  Future<void> getDataPromo() async {
    http.Response data = await http.get("https://dev.bananaz.co/ios/promo/");
    var jsonData = jsonDecode(data.body);
    dataPromo = jsonData;
  }

  Future<void> getFeedData() async {
    http.Response data = await http.get("https://dev.bananaz.co/ios/feed/");
    var jsonData = jsonDecode(data.body);
    dataFeed = jsonData;
  }
...
class AppPage1Bloc {
  ...
  StreamController _appPage1ControllerSuggestion=new StreamController.broadcast();

  Stream get _appPage1Streamer => _appPage1Controller.stream;
  Stream get _appPage1StreamerFeed => _appPage1ControllerFeed.stream;
  Stream get _appPage1StreamerSuggestion=>_appPage1ControllerSuggestion.stream;
  ...
  Future<void>getSuggestionPlaceBloc({input,type})async{
    ...
    if(type == 'pickup'){
      _appPage1ControllerSuggestion.sink.add(_appPage1Provider.pickupDataSuggestionPlace);
    } else if(type == 'return'){
      _appPage1ControllerSuggestion.sink.add(_appPage1Provider.returnDataSuggestionPlace);
    }
  }
...
class _AppPage1State extends State<AppPage1> {
  ...
  Future<void> getDate({String type}) async {
    if (type == "pickup") {
      ...
      final dateResult = await showDatePicker(
        context: context,
        initialDate: datePick == null?DateTime(DateTime.now().year,DateTime.now().month,DateTime.now().day+1):DateTime(datePick.year,datePick.month,datePick.day+1),
  ...
  Future<bool>checkOrder({pickupLocation,pickupDate,pickupTime,returnLocation,returnDate,returnTime})async{
    http.Response data=await http.get("https://dev.bananaz.co/ios/cekreservasi/?pick_up_date=$pickupDate&return_date=$returnDate&pick_up_location=$pickupLocation&return_location=$returnLocation&pick_up_time=$pickupTime&return_time=$returnTime");
                  ...
                  children: <Widget>[
                    new Container(
                      ...
                      child: new FlatButton(
                        child: new Text("Close",style: new TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                        onPressed: ()=>Navigator.pop(context),
                      ),
                    ),
                    new TextFormField(
                      ...
                      onChanged: (value){
                        this.widget._appPage1Bloc.getSuggestionPlaceBloc(input: value,type: "pickup");
                      },
                      autocorrect: false,
                    ...
                    new StreamBuilder(
                      stream: this.widget._appPage1Bloc._appPage1StreamerSuggestion,
                      initialData: this.widget._appPage1Provider.pickupDataSuggestionPlace,
                          ...
                          return Container(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context,i){
                                return new ListTile(
                                  title: new Text(snapshot.data[i]["description"]),
                                  onTap: (){
                                    _pickupLocationController.text=snapshot.data[i]["description"];
                                    this.widget._appPage1Bloc.getSuggestionPlaceBloc(input: "",type: "pickup");
                ...
                child: new Column(
                  ...
                  children: <Widget>[
                    ...
                    new TextFormField(
                      ...
                      onChanged: (value){
                        this.widget._appPage1Bloc.getSuggestionPlaceBloc(input: value,type: "return");
                      },
                      autocorrect: false,
                      cursorColor: Colors.lightBlueAccent,
                      cursorWidth: .9,
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context,i){
                                return new ListTile(
                                  title: new Text(snapshot.data[i]["description"]),
                                  onTap: (){
                                    _returnLocationController.text=snapshot.data[i]["description"];
                                    this.widget._appPage1Bloc.getSuggestionPlaceBloc(input: "",type: "return");
                                    Navigator.pop(context);
                                    setState(() {
...
//                  DESTINATION TEXTFORM FIELD
                      Container(
                        ...
                        child: DropdownButtonFormField<String>(
                          ...
                          items: <String>['Bali - Scooter or motorbike', 'More locations coming soon!',]
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  new FlatButton(
                                    ...
                                    textColor: Colors.white,
                                    onPressed: () => this.getDate(type: "pickup"),
                                    color: Colors.lightBlueAccent,
                      ...
                      new Container(
                        ...
                        child: new FlatButton(
                          ...
                          child: new Row(
                            ...
                            children: <Widget>[
                              new Icon(Icons.location_on,color: Colors.redAccent,),
                              new Expanded(child: new Text(_pickupLocationController.text==""?"Pickup Location":_pickupLocationController.text,textAlign: TextAlign.center,))
                            ],
                          ),
                        )
                      ),
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  new FlatButton(
                                    ...
                                    textColor: Colors.white,
                                    onPressed: () => this.getDate(type: "return"),
                                    color: Colors.lightBlueAccent,
                                    shape: new RoundedRectangleBorder(
                                        borderRadius:
                                            new BorderRadius.circular(3)),
...
//                            TIME FIELD
                        ...
                        decoration: new BoxDecoration(
                          ...
                          child: new FlatButton(
                            ...
                            child: new Row(
                              ...
                              children: <Widget>[
                                new Icon(Icons.location_on,color: Colors.redAccent,),
                                new Expanded(child: new Text(_returnLocationController.text==""?"Return Location":_returnLocationController.text,textAlign: TextAlign.center,))
                              ],
                            ),
                          )
                      ),
                      ...
                      new SizedBox(
                        ...
                        child: new RaisedButton(
                          ...
                          color: Colors.lightBlueAccent,
                          onPressed: ()async{
                            if(timePick == null || datePick == null || timeReturn == null || dateReturn == null || _pickupLocationController.text==""||_returnLocationController.text==""){
                              showDialog(
                                  context: context,
                                  builder: (context){
                                    return Center(child: new Card(
                                      child: new Container(
                                        color: Colors.orangeAccent,
                              ...
                              if(_validated){
                                ...
                                if(timeReturn.minute.toString()=="0"){
                                  ...
                                  returntimefinal = timeReturn.minute.toString();
                                }
                                ...
                                showDialog(
                                  ...
                                  builder: (context){
                                    return new AlertDialog(
                                      backgroundColor: Colors.orangeAccent,
                                      title: new Text("Terms and Conditions",style: new TextStyle(fontWeight: FontWeight.bold),),
                                      content: new Text("To make a reservation, make sure you have a driving licence. After You make a payment, we will ask for a photo proof of driving licence in accordance with our terms and conditions. *We can cancel the reservation if your driving licence is not valid"),
                                      actions: <Widget>[
                                        new FlatButton(
                                          ...
                                          onPressed: (){
                                            ...
                                            Navigator.of(context).push(new MaterialPageRoute(
                                                builder: (context)=>BookWebView(
                                                  idCustomer: id,
                                                  pickupDate: "${datePick.year}/${datePick.month}/${datePick.day}",
                                                  pickupLocation:_pickupLocationController.text ,
                                                  pickupTime: "${timePick.hour}:$pickuptimefinal",
                                                  returnDate: "${dateReturn.year}/${dateReturn.month}/${dateReturn.day}",
                                                  returnTime: "${timeReturn.hour}:$returntimefinal",
                          ...
                          child: new Text("CHECK AVAILBILITY"),
                          shape: new RoundedRectangleBorder(
                              borderRadius: new BorderRadius.circular(3)),
                        ),
                      )
                                ...
                                decoration: new BoxDecoration(
                                    ...
                                    image: new DecorationImage(
                                        image: new NetworkImage(
                                            "https://dev.bananaz.co/assets/upload/image/${snapshot.data[i]["gambar"]}"),
                                        fit: BoxFit.fill)),
                              ),
                            ),
                          ),
                      ...
                      itemBuilder: (context, i) {
                        return new Padding(
                          ...
                          child: new GestureDetector(
                            onTap: (){
                              _openFeed(
                                urlTarget: snapshot.data[i]["id_feed"]
                              );
                            },
                            child: new Container(
                              decoration: new BoxDecoration(
...
class BookWebView extends StatefulWidget {
  ...
  BookWebView({
    this.pickupDate, this.pickupTime, this.pickupLocation, this.returnDate, this.returnTime, this.returnLocation,this.idCustomer});
...
class _BookWebViewState extends State<BookWebView> {
  ...
  void initState() {
    ...
    print("https://dev.bananaz.co/ios/reservasi/?&pick_up_date="+this.widget.pickupDate+"&pick_up_time="+this.widget.pickupTime+"&pick_up_location="+this.widget.pickupLocation+"&return_date="+this.widget.returnDate+"&return_time="+this.widget.returnTime+"&return_location="+this.widget.returnLocation+"&id_customer="+this.widget.idCustomer);
    ...
    loadurls = "https://dev.bananaz.co/ios/reservasi/?pick_up_date="+this.widget.pickupDate+"&pick_up_time="+this.widget.pickupTime+"&pick_up_location="+pickuplocation+"&return_date="+this.widget.returnDate+"&return_time="+this.widget.returnTime+"&return_location="+returnlocation+"&id_customer="+this.widget.idCustomer;

    String skrg = flutterWebviewPlugin.evalJavascript('location.href').toString();
    String urls;
    print(skrg);
    ...
    flutterWebviewPlugin.onUrlChanged.listen((String url) {
      ...
      if(urls.contains("reservation")){
      ...
      }else if(!urls.contains("bananaz.co")){
        titleloading = "";
        ispaypal = true;
        ...
        showDialog(
            ...
            builder: (context){
              return new AlertDialog(
                backgroundColor: Colors.orangeAccent,
                title: new Text("Success! Please to upload your driver licence for a verification",style: new TextStyle(fontWeight: FontWeight.bold),),
                actions: <Widget>[
                  new FlatButton(
                    child: new Text("Click to Continue",style: new TextStyle(color: Colors.white),),
                    onPressed: (){
                ...
                leading: new IconButton(icon: Icon(Icons.close), onPressed: (){
                  ...
                  showDialog(
                    ...
                    builder: (context){
                      return new AlertDialog(
                        backgroundColor: Colors.orangeAccent,
                        title: new Text("Are you sure you want to close this reservation?",style: new TextStyle(fontWeight: FontWeight.bold),),
                        actions: <Widget>[
                          new FlatButton(
                            child: new Text("Close Reservation",style: new TextStyle(color: Colors.redAccent),),
                            onPressed: (){
                              Navigator.pop(context);
                              Navigator.pop(context);
                            },
                          ...
                          new FlatButton(
                            child: new Text("Do not Cancel",style: new TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
                            onPressed: (){
                              Navigator.pop(context);
                              flutterWebviewPlugin.show();
                            },
