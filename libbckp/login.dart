...
class _LoginState extends State<Login> {
  ...
  Future<bool> doRegister(
    ...
    http.Response rq =
        await http.post("https://dev.bananaz.co/ios/register/", body: {
  ...
  Future<bool> emailExist({email}) async {
    ...
    http.Response data =
    await http.get(
        "https://dev.bananaz.co/ios/customer2/?email=$email&android_id="+ prefs.getString("fcmToken"));
...
//    If all data are correct then save data to out variables
  ...
  Future<bool>doLoginToken({email,password})async{
    ...
    //print(fcmToken);
    http.Response loginList = await http.get("https://dev.bananaz.co/ios/login/?email=$email&password=$password&android_id="+prefs.getString("fcmToken"));
  ...
  /*Future<bool> doLogin({email, password}) async {
    ...
    http.Response userData = await http.get(
        "https://dev.bananaz.co/ios/login/?email=$email&password=$password&android_id="+prefs.getString("fcmToken"));
