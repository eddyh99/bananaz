...
{"name": "Zimbabwe", "code": "ZW"}
                  ...
                  children: <Widget>[
                    ...
                    new TextFormField(
                      ...
                      onChanged: (value)async{
                        await this.getCountryData(value);
                      },
                      autocorrect: false,
                    ...
                    new Container(
                      child: new FutureBuilder(
                        future:getCountryData(_countryNameController.text.toLowerCase()),
  ...
  String _phoneNumberValidator(value){
    Pattern pattern =
        r'(^(?:[+0]9)?[0-9]{8,9,10,11,12,13,14,15,16}$)';
                    ...
                    child: new Row(
                      children: <Widget>[
                        new Expanded(
                          child: new Container(
                              decoration: new BoxDecoration(
                                  border: new Border(bottom: new BorderSide(color: Colors.white,width: .4)),
...
class _SignUpJoinState extends State<SignUpJoin> {
  ...
  Future<bool> doLogin({email, password,token}) async {
    http.Response userData = await http.get(
        "https://dev.bananaz.co/ios/login/?email=$email&password=$password&android_id=$token");
  ...
  Future<bool>doRegister({Map data})async{
    http.Response rq=await http.post("https://dev.bananaz.co/ios/register",body: data);
